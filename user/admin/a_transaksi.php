		...
		<main>
			<div class="content">
                ...
                <table>
                    ...
                    <tbody>
                        <?php
                        $query = mysqli_query($conn, "SELECT * FROM d_transaksi ORDER BY id_transaksi ASC");
                        ...
                        <tr>
                            ...
                            <td data-label="Nama Pengirim"><?php echo $d['nama'];?></td>
                            <td data-label="Alamat"><?php echo $data['nominal'];?></td>
                            <td data-label="Bukti Pembayaran"><img src="../../transaksi/<?php echo $data['gambar'];?>" width="500%" height="50%" alt=""></td>
                            <td data-label="Metode"><?php echo $data['metode'];?></td>
                            <td data-label="Status"><?php echo $data['stats'];?></td>
                            <td data-label="">
                                <a href="a_transaksi_edit.php?id=<?php echo $data['id_transaksi'];?>" style="color:green;"><i class="fa fa-th-list"></i> Edit</a> | 
